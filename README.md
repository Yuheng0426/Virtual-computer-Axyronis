...
Released versions are published with Git tags so users can download different versions. The current version is `v1.1.1`, the Axyronis Manager system-care release. Future feature releases will continue as `v1.1.3`, `v1.1.4`, and so on.
...
- Web App Dock shortcuts for Google Search, Gmail, Outlook, WhatsApp Web, Discord, X, Instagram, YouTube, GitHub, and Google Docs inside the internal Chrome window.
...
- `v1.1.3`: Reserved for the next feature update.
